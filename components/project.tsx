...
const Project = ({
    ...
    const opacityProgress = useTransform(scrollYProgress, [0, 1], [0.7, 1.0])
        ...
        <motion.div ref={ref}
            ...
            <section
                className='bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden
                 sm:pr-8 relative sm:max-h-[30rem] group-even:pl-8 rounded-lg
                ...
                <Image src={imageUrl} alt={`${title} snapshot`} quality={90}
                    className='absolute top-8 -right-40 w-[28.25rem] rounded-t-lg shadow-2xl
                    group-even:right-[initial] group-even:-left-40 transition group-hover:scale-105
